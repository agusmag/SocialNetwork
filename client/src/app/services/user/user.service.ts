...
export class UserService{
    ...
    //Método que realiza el request para obtener todos los usuarios según la página indicada
    ...
    //Método que realiza el request para obtener un usuario en particular en base a su id
